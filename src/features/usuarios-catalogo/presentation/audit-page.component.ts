    ...
    @if (loading()) {
      ...
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
              <th title="Número de fila según los filtros actuales">N.º</th>
              <th>Fecha</th>
          ...
          <tbody>
            @for (event of result()?.items || []; track event.id; let index = $index) {
              <tr>
                ...
                <td>
                  {{ event['actor_email'] || (event['actor_user_id'] ? 'Correo no disponible' : 'Sin sesión') }}
                </td>
                <td>{{ event['action'] }}</td>
      ...
      <div class="modal-backdrop">
        ...
        >
          ...
          <dl class="detail-list">
            ...
            <dt>Actor</dt>
            <dd>
              {{ e['actor_email'] || 'Correo no disponible' }}
              @if (e['actor_name']) { <br /><span>{{ e['actor_name'] }}</span> }
              @if (e['actor_user_id']) {
